...
<?php
$per_hal = 6;
$jumlah_record = mysqli_query($koneksi, "SELECT * from produk WHERE id_kategori = 2");
...
<div id="page-title" style="margin-top: 50px; background: grey;border-bottom: 5px solid grey;">
    ...
    <ul class="dropdown-menu" role="menu" aria-labelledby="menu" style="margin-left: 170px">
      <li role="presentation"><a role="menuitem" tabindex="1" href="pakaian.php">Pakaian</a></li>
      <li role="presentation"><a role="menuitem" tabindex="2" href="kerajinan.php">Kerajinan tangan</a></li>
      <li role="presentation"><a role="menuitem" tabindex="3" href="aksesoris.php">Aksesoris</a></li>
    </ul>
  </div>
...
<?php
	if(isset($_GET['cari'])){
				echo '<div> <p style="color="red">Hasil pencarian produk dengan kata kunci "'. $_GET['cari'] .'". </p></div>';
			...
			$produk = mysqli_query($koneksi, "SELECT * FROM produk WHERE id_kategori = 2 LIMIT $start, $per_hal");
			}
