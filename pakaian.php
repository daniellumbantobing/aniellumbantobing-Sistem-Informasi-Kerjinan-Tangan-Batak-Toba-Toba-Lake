...
<?php
$per_hal = 6;
$jumlah_record = mysqli_query($koneksi, "SELECT * from produk WHERE id_kategori = 1");
...
<?php
	if(isset($_GET['cari'])){
			...
			$produk = mysqli_query($koneksi, "SELECT * FROM produk WHERE id_kategori = 1 LIMIT $start, $per_hal");
			}
