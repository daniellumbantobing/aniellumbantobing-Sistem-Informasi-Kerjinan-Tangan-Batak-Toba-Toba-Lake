    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
           <img  style="width: 100%; height: 400px;" src="img/2.jpg" alt="gambar">
        ...
        <div class="item">
          <img style="width: 100%; height: 400px;" src="img/kerajinan1.jpg" alt="gambar">
          <div class="carousel-caption">
          <h1 style="color:red;">Gantungan Kunci</h1>
           <h1></h1>
          </div>
        </div>
        <div class="item">
...
<!--menu pada index-->
 <div class="col-md-12" style="background-color: silver">
   <div class="container" style="background-color: lightblue">
      ...
      <marquee  scrollamount="25" behavior="alternate" ><h1 style="font-family:Comic Sans MS;  color:blue;"><b>Selamat Datang Di Toko Toba Lake</b></h1></marquee>
